# ⚠️  AUTO-SYNCED COPY — DO NOT EDIT.
# Generated from specification/policies/demand-flex-networkpolicy.rego
# Regenerate: specification/scripts/sync-network-policies.sh
#
