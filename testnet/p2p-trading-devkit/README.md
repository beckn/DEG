...
- Registry service (cache layer on top of DeDi, a Beckn-One service) [production](https://api.beckn.io/registry), [test](http://api.testnet.beckn.one/registry). We use test registry server for this demo.
